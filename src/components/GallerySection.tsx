...
export default function GallerySection() {
  ...
  return (
    <SectionCard className="text-center">
      ...
      <Reveal className="mt-2 text-xl">웨딩 갤러리</Reveal>

      <Reveal className="mt-6">
        <div className="relative -mx-6">
          <div
            ref={scrollerRef}
            className=" hide-scrollbar flex snap-x snap-mandatory overflow-x-auto scroll-smooth border-0 bg-neutral-100"
          >
          ...
          <button
            ...
            onClick={() =>
              scrollToIndex(Math.min(activeIndex + 1, galleryImages.length - 1))
            }
            aria-label="다음 사진"
          >
            ›
      ...
      <Reveal className="mt-4">
        <div className="grid grid-cols-5 gap-2 -mx-6 px-6">
